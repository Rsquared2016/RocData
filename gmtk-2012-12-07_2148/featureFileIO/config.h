...
/* Define to 1 if you have the declaration of `M_SQRT1_2', and to 0 if you
   don't. */
#define HAVE_DECL_M_SQRT1_2 1

/* Define to 1 if you have the declaration of `M_SQRT2', and to 0 if you
   don't. */
#define HAVE_DECL_M_SQRT2 1
