 ...
 */
package in.fount.util.logback.web;

import in.fount.util.logback.LogbackConfigurer;
...
public class WebLogbackConfigurer {
    ...
    private static final String DEFAULT_CONFIG_LOCATION = "classpath:logback.xml";
