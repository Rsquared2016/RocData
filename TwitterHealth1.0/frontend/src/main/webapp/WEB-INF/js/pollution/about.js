...
function AboutWindow(map) {
	...
	"<p>To learn more about our models, visit <a href='http://www.cs.rochester.edu/~sadilek/research/'>our research website</a>.</div>");
